...
public class TestController {
	...
	public static final String basePath = "E:/eclipse-workspace/web_demo/style_transfer-dev2/";
	...
	public String upLoad(HttpServletRequest request, HttpServletResponse response, Integer userId, HttpSession session)
			throws Exception {
		System.err.println("-------------------------------------");
		...
		if (multipartRequest != null) {
			...
			System.out.println("-------------------------------------");
			System.out.println(
					"File:\t" + newFileName1 + "\tType:\t" + file1.getContentType() + "\tSize:\t" + file1.getSize());
			System.out.println(
					"File:\t" + newFileName2 + "\tType:\t" + file2.getContentType() + "\tSize:\t" + file2.getSize());
			/*
			 * System.out.println("-------------------------------------");
			...
			// 调用转换图片
			int result = 100;
			result = TransferImage.getTrans_img().transfer_image(filepath1 + newFileName1, filepath2 + newFileName2,
					filepath3 + "res.jpg");
