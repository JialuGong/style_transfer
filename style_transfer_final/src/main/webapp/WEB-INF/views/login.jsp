                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <script>
                            function edit()
                            {
                                location.href="<%=basePath%>welcome/login"
                            }
                            function edit3(){
                                location.href="<%=basePath%>welcome/enter"
                            }
                        </script>
                    </ul>
                </div>
                ...
                <div class="col-md-12 section-heading text-center">
                    <h1 class="p">
                        <div class="fh5co-portfolio animate-box">
                            <!-- form  class="form-signin" action="" method="post" id="form_submit"-->
                                ...
                                <div class="checkbox mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 section-title text-center" style="font-size: small;margin-top: 9px">
                                                <label>
                                                    <a type="checkbox" href="<%=basePath %>welcome/register"><u><e class="s2">注册</e></u></a>
                                                </label>
                                                <label>
                                                    <a type="checkbox" href="<%=basePath%>welcome/enter"><u><e class="s2">主页</e></u></a>
                                                </label>
                                        </div>

                                    </div>
                                </div>
                                <button class="btn btn-md btn-primary"  onclick="login()" type="submit"><e class="s2">登录</e></button>
