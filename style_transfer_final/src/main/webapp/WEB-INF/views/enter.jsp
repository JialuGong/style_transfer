                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        ...
                        <div class="call-to-action">
                            <a onclick="location.href='<%=basePath%>welcome/register'"  class="demo animate-box"><i class="icon-power"></i>注册</a>
                            <a onclick="location.href='<%=basePath%>welcome/login'" data-nav-section="explore" class="download animate-box"><i class="icon-download"></i> <span>登陆</span></a>
                        </div>
                    </div>
                </div>
            </div>
