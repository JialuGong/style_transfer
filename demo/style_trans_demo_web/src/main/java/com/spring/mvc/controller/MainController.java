...
public class MainController {
	...
	public static final String basePath = "~/tomcat/webapps/style_trans_demo_web";
	...
	public String upLoad(HttpServletRequest request, HttpServletResponse response, Integer userId) throws Exception {
		...
		if (multipartRequest != null) {
			// 原图片路径
			String filepath1 = basePath + "/public/transfer/origin_img/";
			// 风格图片路径
			String filepath2 = basePath + "/public/transfer/style_img/";
			// 转化后图片路径
			String filepath3 = basePath + "/public/transfer/result_img/";
			//	从request接收文件
