...
<script>
    ...
    (function() {
        ...
        hm.src = "https://hm.baidu.com/hm.js?0fcdd431c6230ad57319d7beb9142f79";
...
<div id="container">
    ...
    <div id="text" onclick="location.href='<%=basePath%>welcome/enter'">
        <h1 id="h1">Style Manager</h1>
        <br />
        <h2 id="h2">Welcome to use</h2>
        <br />
        <p>&nbsp;</p>
        <p class="bottom_text">make your own masterpiece<br><span>click to start</span></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<script data-cfasync="false" src="https://cdn.pplin.cn/threebodyspace/js/email-decode.min.js"></script>
<script>
